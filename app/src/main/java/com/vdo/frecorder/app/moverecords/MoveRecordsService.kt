...
import com.vdo.frecorder.util.OnCopyListener
import com.vdo.frecorder.util.copyFileToDir
...
class MoveRecordsService : Service() {
	...
	companion object {
		...
		private const val CHANNEL_ID = "com.vdo.frecorder.MoveRecords.Notification"
