...
import com.vdo.frecorder.AppConstants.DECODE_DURATION
import com.vdo.frecorder.AppConstants.PENDING_INTENT_FLAGS
import com.vdo.frecorder.BackgroundQueue
import com.vdo.frecorder.ColorMap
import com.vdo.frecorder.R
import com.vdo.frecorder.app.main.MainActivity
import com.vdo.frecorder.audio.AudioDecodingListener
...
import com.vdo.frecorder.util.isUsingNightModeResources
...
class DecodeService : Service() {
	...
	companion object {
		...
		private const val CHANNEL_ID = "com.vdo.frecorder.Decode.Notification"
